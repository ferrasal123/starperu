...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		prevText: "Antes", // Display text for previous month link
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: "fechas", // Text for trigger button
		...
		minDate: "-1y", // The earliest selectable date, or null for no limit
		maxDate: "+1y", // The latest selectable date, or null for no limit
