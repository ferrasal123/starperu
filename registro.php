...
<head>
	...
	<title>Aerolíneas Star Perú</title>
                ...
                <div class="col-12">
                    <div class="register-box">
                        <div class="register-logo">
                            <a href=""><b>Por favor registrar sus datos, para recibir nuestro newsletter:</b></a>
                        </div>

                        <div class="register-box-body">
                            <p class="login-box-msg"></p>
                            <form action="inserta_pasajeros.php" method="POST">
                                <div class="form-group has-feedback">
                                    <input type="text"  name="nombre" class="form-control"  onKeyUp="this.value=this.value.toUpperCase();" placeholder="Nombres" required>
                                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                </div>
                                <div class="form-group has-feedback">
                                    <input type="text" name="apellido" class="form-control" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Apellidos" required>
                                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                </div>
                                <div class="form-group has-feedback">
                                    <input type="email" name="email" class="form-control" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Email" required>
                                ...
                                <div class="form-group">
                                  <div class="form-check">
                                      ...
                                      <label class="form-check-label" for="defaultCheck1">
                                          Acepto entregar mis datos a Starperú
                                      </label>
                                  </div>
                                </div>
                                <div class="row">
                                    <!-- /.col -->
                                    <div class="col-xs-5">
                                        <input type="submit" name="enviar" class="btn btn-primary btn-block btn-flat" value="Registrar">
                                    </div>
                                    <!-- /.col -->
                                </div>
                            </form>
                    ...
                    <div class="row no-gutters align-items-end">
                        <div class="col-sm-12 col-md-9">
                                    <p>CALL CENTER (511) 705-9000 <br>
                                        LUNES A VIERNES  07:00 A 21:00HRS <br>
                                        SABADO, DOMINGO Y FERIADO 08:00 A 20:00HRS.</p>
                                </div>
...
<script type="text/javascript" src="../lib_test/index.js"></script>
